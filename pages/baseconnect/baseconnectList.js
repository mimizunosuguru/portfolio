        ...
        <Section grey>
          ...
          <Desc>
            <li>
              ...
              <p className="cont">本サービスをローンチするにあたり、IE等のブラウザ対応や最終段階の細かな調整、サービスリリース後も機能改善による細かな修正を行なっています。</p>
            </li>
            <li className="descList__item">
              <p className="title">担当箇所</p>
              <p className="cont">ワイヤーフレームを元に、直感的でわかりやすい操作性を重視したUI/UXデザインとHTML/CSS/Reactを用いてフロントのコーディングまで担当しました。</p>
            </li>
            <li className="descList__item">

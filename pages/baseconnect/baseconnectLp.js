        ...
        <TopImage src="/static/image/work/baseconnect-lp.jpg"/>
          <Section grey>
            ...
            <Content>
              ...
              <h3>デザインプロセス</h3>
              <p>企業情報のデータベースとなる「Baseconnect LIST」は担当した当時β版でのリリースになっていたため、サービスの肝となる企業情報の数が十分ではありませんでした。</p>

              <p>この問題を解決するため要件として挙げられたのが「リアルタイムで企業情報のデータを作成していることをユーザーに知らせる」であり、<b>「ダッシュボード・掲示板」を想起させるグラフィック</b>を取り入れることで、課題解決にアプローチしました。</p>
              <Image>
              ...
              <p>もう1つのサービスの課題は、企業情報のデータ作成は主に関西と関東を中心としているため、地域によってデータの数にばらつきがあることでした。</p>

        ...
        <TopImage src="/static/image/work/baseconnect-lp.jpg"/>
          <Section grey>
            ...
            <Content>
              ...
              <p>もう1つのサービスの課題は、企業情報のデータ作成は主に関西と関東が中心であり、地域ごとにデータ数にばらつきがあることでした。</p>
              <p>そのため、サービスの導入を検討するユーザーが懸念する「自分が営業したい会社の情報はあるか？」に答えるため、<b>企業情報が多い都道府県をランキング形式で一覧表示</b>しました。</p>

      ...
      <Layout>
        ...
        <Content>
          ...
          <Section grey>
            ...
            <h4>結果</h4>
            <p>約160名ほど説明会の応募があり、40名がカリキュラム受講、内5名がインターンとして現在も活動しています。</p>
            ...
            <ul>
              ...
              <li>・相手が何でつまずき、どうすれば次の壁を乗り越えられるかを考える</li>
              <li>・デザインの原理原則に基づき、理由を踏まえフィードバックする</li>
              <li>・知っていればできたこと、手を動かすことで身に付いていくものを明らかにしてあげる</li>
              <li>・道具の使い方はなるべく教えない</li>
              <li>・デザインする際の視点、わからないことの調べ方、作業のプロセスに関してアドバイスする</li>
            </ul>

            <h4>人に教えることは、自身の学びになる</h4>
            <p>自身もインターンという立場で日々業務があり、まだまだデザイナーとして学んでいく段階ではありますが、人に何かを教える / フィードバックするという経験は、とても学ぶことが多かったです。特に、相手がどう動いてくれるかを考え、自分が関わり、アドバイスをするかは、今でも自分が意識しているテーマになっています。</p>
            <p>また、デザインのアウトプットに対して、何が良くて、何が悪いかを言葉にすることは、自分のデザインを説明する訓練にもなりました。</p>

      ...
      <Layout>
        ...
        <Section grey>
          ...
          <Content>
            ...
            <p>自分もまだまだデザイナーとして成長段階ではあるものの、人に何かを教える / フィードバックする過程には、たくさんの学びがありました。相手の学習 / 成長を促進できるように、フィードバックする際は下記のポイントを心がけました。</p>
            <ul>
              <li>・どんなプロセスで学習 / アウトプットをしたかに耳を傾ける</li>
              <li>・相手が何でつまずき、どうすれば次の壁を乗り越えられるかを一緒に考える</li>
              <li>・デザインの原理原則に基づき、理由を踏まえフィードバックする</li>
              <li>・知っていればできた、手を動かして身に付つくことの違いを明らかにする</li>
